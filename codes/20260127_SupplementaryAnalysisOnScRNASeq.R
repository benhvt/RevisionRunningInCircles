...
#------------------------------------------------------------------------------
# 3. Gene filtering: top variable genes
#------------------------------------------------------------------------------
...
counts_reduced <- raw_counts[, top_genes]
...
write.csv(results_df, file = "results/SupplementaryResultsApplicationOnScRNASeq.csv")
